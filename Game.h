...
private:
  ...
  bool isInBatman(const Point &point, const Point &origin, const double scale);
  ...
  bool inOval(const Point &point, const Point &origin, const Point &ovalRadius);

  double calculateError(const MonteCarloArgs &args);
