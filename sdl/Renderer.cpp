                       ...
                       const int32_t windowHeight)
{
    ...
    //Create window
    _window = SDL_CreateWindow("Batman",
                               windowX,
                               windowY,
                               windowWidth,
                               windowHeight,
    ...
    if(EXIT_SUCCESS == err)
    {
        ...
        _sdlRenderer =  SDL_CreateRenderer(_window,
                                           -1,
...
{
    if(EXIT_SUCCESS !=
        SDL_SetRenderTarget(_sdlRenderer, _textureContainer.getTexture(rsrcId)))
    {
...
void Renderer::drawPoints(const SDL_Point * points,
                          const int32_t     count)
{
